            ...
            <div class="page-content-tab">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="card">
                                    <div class="card-body">
                                        <form class="needs-validation mt-4" action="./controllers/gs-controllers/sub-add-currencies.php" method="POST" novalidate> 
                                                    <div class="form-row">
                                                        <div class="col-md-2 mb-3">
                                                            <input type="text" class="form-control" name="code" id="validationCustom01" placeholder="Currency Code" required>
                                                        ...
                                                        <div class="col-md-2 mb-3">
                                                            ...
                                                            <input type="text" class="form-control" name="name" id="validationCustom01" placeholder="Currency Name"  required>
                                                            <div class="valid-feedback">
                                                                Looks good!
                                                            </div>
                                                            <div class="invalid-feedback">
                                                        ...
                                                        <div class="col-md-2 mb-3">
                                                            <input type="date" class="form-control" name="effective" id="validationCustom01" placeholder="Effective date"  required>
                                                            <div class="valid-feedback">
                                                                Looks good!
                                                            </div>
                                                            <div class="invalid-feedback">
                                                        ...
                                                        <div class="col-md-2 mb-3">
                                                            <input type="date" class="form-control" name="expiry" id="validationCustom01" placeholder="Expiry date"  required>
                                                            <div class="valid-feedback">
                                                                Looks good!
                                                            </div>
                                                            <div class="invalid-feedback">
                                        ...
                                        <table id="footable-2" class="table mb-0" data-filtering="true"  data-show-toggle="false">
                                                <thead>
                                                    <tr>
                                                        <th data-name="jjj">Currency Code</th>
                                                        <th data-name="firstName">Currency Name</th>
                                                        <th data-name="lastName" width="10%">Description</th>
                                                        <th data-name="ddsf"> Effective date</th>
                                                        <th data-name="ddsf"> Expiry date</th>
                                                        <th data-name="Del">Delete</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <?php require('./includes/populate-gs-tables/sub-main-currencies-table.php'); ?>
                                                </tbody>
                                        </table>
      ...
      <script>
        ...
        function clickedIcon(id){
            ...
            var element2 = document.createElement("input");         
                ...
                element2.value = "sub-main-gs-currencies.php";
                element2.type = 'text';
                form.appendChild(element2);
            var element3 = document.createElement("input");         
                element3.name="table_name"
                element3.value = "currencies";
                element3.type = 'text';
