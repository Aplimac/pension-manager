                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                    <div class="card-body">
                                        <form class="needs-validation mt-4" action="./controllers/gs-controllers/sub-main-add-countries.php" method="POST" novalidate> 
                                                    <div class="form-row">
                                                        ...
                                                        <div class="col-md-3 mb-3">
                                                            <input type="text" class="form-control" name="code" id="validationCustom01" placeholder="Country Code"  required>
                                                            <div class="valid-feedback">
                                                                Looks good!
                                                            </div>
                                                            <div class="invalid-feedback">
                                                        ...
                                                        <div class="col-md-3 mb-3">
                                                            <input type="text" class="form-control" name="telephone" id="validationCustom01" placeholder="Telephone Code"  required>
                                                            <div class="valid-feedback">
                                                                Looks good!
                                                            </div>
                                                            <div class="invalid-feedback">
                                        ...
                                        <table id="footable-2" class="table mb-0" data-filtering="true"  data-show-toggle="false">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th data-name="lastName">Country Code</th>
                                                        <th data-name="Del">Telephone Code</th>
                                                        <th data-name="Del">Delete</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <?php require('./includes/populate-gs-tables/sub-main-countries-table.php') ?>
                                                </tbody>
                                        </table>
      ...
      <script>
        ...
        function clickedIcon(id){
            ...
            var element2 = document.createElement("input");         
                ...
                element2.value = "sub-main-gs-countries.php";
                element2.type = 'text';
                form.appendChild(element2);
            var element3 = document.createElement("input");         
                element3.name="table_name"
                element3.value = "countries";
                element3.type = 'text';
