                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">Register Directors</h4>
                                    ...
                                    <form class="needs-validation" method="POST" novalidate> 
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                        ...
                                                        <input type="text" name="reassuarance_no" class="form-control" id="validationCustom02"   required>
                                                        <div class="valid-feedback">
                                                            Looks good!
                                                        </div>
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-4 mb-3">
                                                        <label for="validationCustom02"> Date Appointed</label>
                                                ...
                                                <div class="col-md-4 mb-3">
                                                        <label for="validationCustom02">Appointed Position </label>
                                            ...
                                            <button class="btn btn-gradient-primary" type="submit">Save Directors Details</button>
                                    </form> <!--end form-->
                                </div>
                            </div>   
                        </div><!--end col-->
