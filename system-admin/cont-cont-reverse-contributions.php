                            ...
                            <div class="page-title-box">
                                <div class="float-right">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="javascript:void(0);">Contributions</a></li>
                                        <li class="breadcrumb-item active"> Reverse Contributions</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">Reverse Contributions</h4>
                        ...
                        <div class="card">
                                <div class="card-body">
                                    <form role="search" class="">
                                        <input type="text" id="AllCompo" placeholder="Cost Center Search" class="form-control ui-autocomplete-input col-md-8" autocomplete="off">
                                    </form>
                                    <form class="needs-validation mt-4" method="POST" novalidate> 
                                                <div class="form-row">
                                                    <div class="col-md-4 mb-3">
                                                        <label for="validationCustom01">Cost Center</label>
                                                        <input type="text" class="form-control" name="reg_no" id="validationCustom01" readonly required>
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        ...
                                                        <select type="text" name="scheme_default_currency" class="form-control" id="validationCustom02" placeholder="Scheme Default Currency"   required> 
                                                                <option value="ZWL">Bulk Reversal</option>
                                                                <option value="USD">Individual Reversal</option>
                                                        </select>                                                        
                                                        <div class="valid-feedback">
                                                            Looks good!
                                                        </div>
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        ...
                                                        <input type="month" name="scheme_name" class="form-control" id="validationCustom02"   required>
                                                        <div class="valid-feedback">
                                                            Looks good!
                                                        </div>
                                                        <div class="invalid-feedback">
                                                ...
                                                <div class="form-row">
                                                    <div class="col-md-4 mb-3">
                                                        <label for="validationCustom02">Period Date</label>
                                                        <input type="month" name="scheme_name" class="form-control" id="validationCustom02"   required>
                                                ...
                                                <div class="form-row">
                                                    <button class="btn btn-gradient-primary" >Reverse Contributions</button>
                                                </div>
                                    </form> <!--end form-->
