                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">Upload Receipt</h4>
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <form class="needs-validation mt-4" method="POST" novalidate> 
                                                <div class="form-row">
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        ...
                                                        <select type="text" name="scheme_default_currency" class="form-control" id="validationCustom02" placeholder="Scheme Default Currency"   required> 
                                                           <option value="ZWL">Select Period</option>
                                                        </select>                                                        
                                                        <div class="valid-feedback">
                                                            Looks good!
                                                        </div>
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        ...
                                                        <input type="file" name="scheme_name" class="form-control" id="validationCustom02"   required>
                                                        <div class="valid-feedback">
                                                            Looks good!
                                                        </div>
                                                        <div class="invalid-feedback">
                                                ...
                                                <div class="form-row">
                                                    <button class="btn btn-gradient-primary m-1" >Validate </button>
                                                    <button class="btn btn-gradient-primary m-1" >Proess </button>
                                                    <button class="btn btn-gradient-primary m-1" >New Members</button>
                                                    <button class="btn btn-gradient-primary m-1" >Possible Transfers </button>
                                                    <button class="btn btn-gradient-success m-1" >Authorise</button>
                                                </div>
                                    </form> <!--end form-->
                                </div>
                            </div>
