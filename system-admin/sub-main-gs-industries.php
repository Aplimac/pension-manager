                                    ...
                                    <div class="card-body">
                                        <form class="needs-validation mt-4" method="POST" novalidate> 
                                                    <div class="form-row">
                                                            ...
                                                            <div class="col-md-3 mb-3">
                                                                <input type="text" class="form-control" name="reg_no" id="validationCustom01" placeholder="Industry Code"  required>
                                                                <div class="valid-feedback">
                                                                    Looks good!
                                                                </div>
                                                                <div class="invalid-feedback">
                                                        ...
                                                        <div class="form-row">
                                                            <div class="col-md-3 mb-3">
                                                                <input type="text" class="form-control" name="reg_no" id="validationCustom01" placeholder=" Rate"  required>
                                                                <div class="valid-feedback">
                                                                    Looks good!
                                                                </div>
                                                                <div class="invalid-feedback">
                                                            ...
                                                            <div class="col-md-3 mb-3">
                                                                <input type="date" class="form-control" name="reg_no" id="validationCustom01" placeholder=" Rate"  required>
                                                                <div class="valid-feedback">
                                                                    Looks good!
                                                                </div>
                                                                <div class="invalid-feedback">
