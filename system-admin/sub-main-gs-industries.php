            ...
            <div class="page-content-tab">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="card">
                                    <div class="card-body">
                                        <form class="needs-validation mt-4" action="./controllers/gs-controllers/sub-main-add-industry.php" method="POST" novalidate> 
                                                    <div class="form-row">
                                                            ...
                                                            <div class="col-md-3 mb-3">
                                                                <input type="text" class="form-control" name="industry" id="validationCustom01" placeholder="Industry "  required>
                                                                <div class="valid-feedback">
                                                                    Looks good!
                                                                </div>
                                                                <div class="invalid-feedback">
                                                        ...
                                                        <div class="form-row">
                                                            <div class="col-md-3 mb-3">
                                                                <input type="text" class="form-control" name="rate" id="validationCustom01" placeholder=" Rate"  required>
                                                                <div class="valid-feedback">
                                                                    Looks good!
                                                                </div>
                                                                <div class="invalid-feedback">
                                                            ...
                                                            <div class="col-md-3 mb-3">
                                                                <input type="date" class="form-control" name="date" id="validationCustom01" placeholder=" Rate"  required>
                                                                <div class="valid-feedback">
                                                                    Looks good!
                                                                </div>
                                                                <div class="invalid-feedback">
                                        ...
                                        <table id="footable-2" class="table mb-0" data-filtering="true"  data-show-toggle="false">
                                                <thead>
                                                    <tr>
                                                        <th data-name="firstName">Country  </th>
                                                        <th data-name="lastName">Industry</th>
                                                        <th data-name="Del"> Code</th>
                                                        <th data-name="ds">Description</th>
                                                        <th data-name="esfe"> Rate</th>
                                                        <th data-name="sdhayt" >Date</th>
                                                        <th data-name="Del">Delete</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                   <?php require('./includes/populate-gs-tables/sub-main-industry-table.php') ?>
                                                </tbody>
                                        </table>
      ...
      <script>
        ...
        function clickedIcon(id){
            ...
            var element2 = document.createElement("input");         
                ...
                element2.value = "sub-main-gs-industries.php";
                element2.type = 'text';
                form.appendChild(element2);
            var element3 = document.createElement("input");         
                element3.name="table_name";
                element3.value = "industry";
                element3.type = 'text';
