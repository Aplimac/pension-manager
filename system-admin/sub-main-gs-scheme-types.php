                ...
                <div class="container-fluid">
                            ...
                            <div class="page-title-box">
                                <div class="float-right">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active"> Scheme Types</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">Scheme Types</h4>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                    <div class="card-body">
                                        <form class="needs-validation mt-4" action="./controllers/gs-controllers/sub-main-gs-scheme-type-controller.php" method="POST" novalidate> 
                                                    <div class="form-row">
                                                        <div class="col-md-4 mb-3">
                                                            <input type="text" class="form-control" name="scheme_name" id="validationCustom01" placeholder="Scheme Type" required>
                                        ...
                                        <table id="footable-2" class="table mb-0" data-filtering="true"  data-show-toggle="false">
                                                <thead>
                                                    <tr>
                                                        <th data-name="firstName">Scheme Type</th>
                                                        <th data-name="lastName" width="10%">Code</th>
                                                        <th data-name="Del">Delete</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <?php require('./includes/populate-gs-tables/sub-main-gs-scheme-type-table.php') ?>
                                                </tbody>
                                        </table>
      ...
      <script>
        ...
        function clickedIcon(id){
            ...
            var element2 = document.createElement("input");         
                ...
                element2.value = "sub-main-gs-scheme-types.php";
                element2.type = 'text';
                form.appendChild(element2);
            var element3 = document.createElement("input");         
                element3.name="table_name";
                element3.value = "scheme_types";
                element3.type = 'text';
