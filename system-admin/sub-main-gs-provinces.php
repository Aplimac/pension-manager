            ...
            <div class="page-content-tab">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="card">
                                    <div class="card-body">
                                        <form class="needs-validation mt-4" action="./controllers/gs-controllers/sub-main-add-province.php" method="POST" novalidate> 
                                                    <div class="form-row">
                                                        ...
                                                        <div class="col-md-3 mb-3">
                                                            <input type="text" class="form-control" name="province" id="validationCustom01" placeholder="Province "  required>
                                                            <div class="valid-feedback">
                                                                Looks good!
                                                            </div>
                                                            <div class="invalid-feedback">
                                        ...
                                        <table id="footable-2" class="table mb-0" data-filtering="true"  data-show-toggle="false">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th data-name="lastName">Province </th>
                                                        <th data-name="Del">Code</th>
                                                        <th data-name="Del">Delete</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                   <?php  require('./includes/populate-gs-tables/sub-main-province-table.php') ?>
                                                </tbody>
                                        </table>
      ...
      <script>
        ...
        function clickedIcon(id){
            ...
            var element2 = document.createElement("input");         
                ...
                element2.value = "sub-main-gs-provinces.php";
                element2.type = 'text';
                form.appendChild(element2);
            var element3 = document.createElement("input");         
                element3.name="table_name";
                element3.value = "provinces";
                element3.type = 'text';
