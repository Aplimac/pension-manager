                            ...
                            <div class="page-title-box">
                                <div class="float-right">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active"> Register K.Y.C Documents</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">Register K.Y.C Documents</h4>
                                    ...
                                    <form class="needs-validation" novalidate> 
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-4 mb-3">
                                                        ...
                                                        <input type="text"  name="commencement_date"  class="form-control" > 
                                                        <div class="valid-feedback">
                                                            Looks good!
                                                        </div>
                                                    <div class="invalid-feedback">
                                                ...
                                                <div class="col-md-4 mb-3">
                                                        ...
                                                        <input type="text"  name="rules_amendment_date"  class="form-control"> 
                                                        <div class="valid-feedback">
                                                            Looks good!
                                                        </div>
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="file" id="input-file-now" class="dropify" />                                                  <div class="valid-feedback">
                                                        Looks good!
                                                    </div>
                                                    <div class="invalid-feedback">
                                                        Make sure your input is in number format!
