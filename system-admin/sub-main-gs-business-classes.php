            ...
            <div class="page-content-tab">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="card">
                                    <div class="card-body">
                                        <form class="needs-validation mt-4" action="./controllers/gs-controllers/sub-main-add-business-class.php" method="POST" novalidate> 
                                                    <div class="form-row">
                                                        ...
                                                        <div class="col-md-2 mb-3">
                                                            <input type="text" class="form-control" name="code" id="validationCustom01" placeholder="Class Code"  required>
                                                            <div class="valid-feedback">
                                                                Looks good!
                                                            </div>
                                                            <div class="invalid-feedback">
                                        ...
                                        <table id="footable-2" class="table mb-0" data-filtering="true"  data-show-toggle="false">
                                                ...
                                                <tbody>
                                                 <?php require('./includes/populate-gs-tables/sub-main-business-class-table.php') ?>
                                                </tbody>
                                        </table>
      ...
      <script>
        ...
        function clickedIcon(id){
            ...
            var form = document.createElement("form");
             ...
             form.method = "POST";
             form.action = "controllers/gs-controllers/sub-delete-business-class.php";
            ...
            var element2 = document.createElement("input");         
                ...
                element2.value = "sub-main-gs-business-classes.php";
                element2.type = 'text';
