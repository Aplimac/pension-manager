            ...
            <div class="page-content-tab">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">Job Titles</h4>
                    ...
                    <div class="row">
                        ...
                        <div class="card">
                                    <div class="card-body">
                                        <form class="needs-validation mt-4" action="./controllers/gs-controllers/sub-main-add-job-title.php" method="POST" novalidate> 
                                                    <div class="form-row">
                                        ...
                                        <table id="footable-2" class="table mb-0" data-filtering="true"  data-show-toggle="false">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th data-name="lastName"> Code</th>
                                                        <th data-name="Del">Description </th>
                                                        <th data-name="Del">Delete</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                 <?php require('./includes/populate-gs-tables/sub-main-job-title-table.php') ?>
                                                </tbody>
                                        </table>
      ...
      <script>
        ...
        function clickedIcon(id){
            ...
            var element2 = document.createElement("input");         
                ...
                element2.value = "sub-main-gs-job-titles.php";
                element2.type = 'text';
                form.appendChild(element2);
            var element3 = document.createElement("input");         
                element3.name="table_name";
                element3.value = "job_titles";
                element3.type = 'text';
