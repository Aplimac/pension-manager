                            ...
                            <div class="page-title-box">
                                <div class="float-right">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active"> Register Facilities</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">Register Facilities</h4>
                                ...
                                <div class="card-body">
                                    <form class="needs-validation" novalidate> 
                                                <div class="form-row">
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        <label for="validationCustom02">Employer Name</label>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        <label for="validationCustom02">Facility Name</label>
                                                ...
                                                <div class="form-row">
                                                    <div class="col-md-6 mb-3">
                                                        <label for="validationCustom01">Facility Location</label>
                                                        <input type="text" class="form-control" name="tax_no" id="validationCustom02"   required>                                                      
                                                        <div class="valid-feedback">
                                                            Looks good!
                                                        </div> 
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        <label for="validationCustom02">Date Commissioned </label>
                                                        <input type="text" class="form-control" name="tax_no" id="validationCustom02"   required>
                                                        <div class="valid-feedback">
                                                            Looks good!
                                                        </div>
                                                ...
                                                <div class="form-row">
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <select type="text" name="country" class="form-control" id="validationCustom02" placeholder="Counrty"   required> 
                                                            <option value="Zimbabwe">Select status</option> 
                                                        </select>                                                        <div class="valid-feedback">
                                                            Looks good!
                                                        </div> 
                                                        <div class="invalid-feedback">
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        <label for="validationCustom02">Inspection Frequency</label>
                                                        <select type="text" name="country" class="form-control" id="validationCustom02" placeholder="Counrty"   required> 
                                                            <option value="Zimbabwe">Select Frequency</option> 
                                                        </select>                                                         <div class="valid-feedback">
                                                            Looks good!
                                                        </div>
                                                        <div class="invalid-feedback">
                                                ...
                                                <button class="btn btn-gradient-primary" type="submit">Save Inspection Details</button>
                                    </form> <!--end form-->
                                </div>
                            </div>
