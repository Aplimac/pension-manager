                            ...
                            <div class="page-title-box">
                                <div class="float-right">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="javascript:void(0);">Contributions</a></li>
                                        <li class="breadcrumb-item active"> Bulk Contributions (Receipting)</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">Bulk Contributions (Receipting)</h4>
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <form class="needs-validation" novalidate> 
                                          ...
                                          <div class="form-row">
                                              <button class="btn btn-gradient-primary" >Begin Receipting</button>
                                          </div>
                                </form> <!--end form-->
                                </div>
                            </div>
