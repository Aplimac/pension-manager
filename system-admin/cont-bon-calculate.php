                            ...
                            <div class="page-title-box">
                                <div class="float-right">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active"> Calculate Acturial Bonus</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">Calculate Acturial Bonus</h4>
                                    ...
                                    <form class="needs-validation" method="POST" action="./controllers/create_schema.php" novalidate> 
                                        <div class="form-row">
                                            <div class="col-md-12 mb-3">
                                                <label for="validationCustom01">Download Option</label>
                                                <select type="text"  class="form-control" name="reg_no" id="validationCustom01"   required>
                                                    <option></option>
                                                    <option></option>
                                                </select>
                                            ...
                                            <div class="col-md-12 mb-3">
                                                <label for="validationCustom02">Bonus Type</label>
                                           ...
                                           <div class="form-row">
                                            <div class="col-md-6 mb-3">
                                                <label for="validationCustom02">Rate Type:</label>
                                         ...
                                         <div class="form-row">
                                            <div class="col-md-6 mb-3">
                                                <label for="validationCustom02">Bonus Date</label>
                                                <input type="date" name="scheme_name" class="form-control" id="validationCustom02"   required>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <label for="validationCustom02">Bonus Rate:</label>
                                                <input type="date" name="scheme_name" class="form-control" id="validationCustom02"   required>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                        ...
                                        <button class="btn btn-gradient-primary" type="submit">Calculate Bonus form</button>
                                    </form> <!--end form-->                                          
                                </div><!--end card-body-->
                            </div><!--end card-->
                        </div><!--end col-->
