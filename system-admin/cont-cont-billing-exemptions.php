                            ...
                            <div class="page-title-box">
                                <div class="float-right">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="javascript:void(0);">Contributions</a></li>
                                        <li class="breadcrumb-item active"> Billing Exemptions</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">Billing Exemptions</h4>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form role="search" class="">
                                        <input type="text" id="AllCompo" placeholder="Search companies" class="form-control ui-autocomplete-input col-md-8" autocomplete="off">
                                    </form>
                                    <div class="form-row">
