                            ...
                            <div class="page-title-box">
                                <div class="float-right">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active"> Register Business Activities</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">Register Business Activities</h4>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form class="needs-validation" method="POST" novalidate> 
                                                ...
                                                <div class="form-row">
                                                    <div class="col-md-6 mb-3">
                                                            <label for="validationCustom02">Unassigned Activities</label>
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                            <label for="validationCustom02">Assigned Activities</label>
                                                            <textarea name="" id="" cols="30" rows="10"></textarea>
                                                            <div class="valid-feedback">
                                                                Looks good!
                                                            </div>
                                                ...
                                                <button class="btn btn-gradient-warning" type="">Previous</button>
                                                <button class="btn btn-gradient-success" type="">Next</button>
                                                <button class="btn btn-gradient-danger" type="">Cancel</button>
                                    </form> <!--end form-->
                                </div>
                            </div>
                        </div><!--end col-->
