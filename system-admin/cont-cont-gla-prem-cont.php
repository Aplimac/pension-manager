                            ...
                            <div class="page-title-box">
                                <div class="float-right">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="javascript:void(0);">Contributions</a></li>
                                        <li class="breadcrumb-item active"> GLA Premium Contributions</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">GLA Premium Contributions</h4>
                                    ...
                                    <form class="needs-validation" novalidate> 
                                        <div class="form-row">
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <select type="text" name="scheme_default_currency" class="form-control" id="validationCustom02" placeholder="Scheme Default Currency"   required> 
                                                        <option value="ZWL">Select branch</option>
                                                    </select>                                                    
                                                    <div class="valid-feedback">
                                                        Looks good!
                                                    </div>
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <select type="text" name="scheme_default_currency" class="form-control" id="validationCustom02" placeholder="Scheme Default Currency"   required> 
                                                        <option value="ZWL">Select year</option>
                                                    </select>                                                    
                                                    <div class="valid-feedback">
                                                        Looks good!
                                                    </div>
                                        ...
                                        <div class="form-row">
                                                <div class="col-md-4 mb-3">
                                                    <label for="validationCustom01">Period </label>
                                                    <select type="text" name="scheme_default_currency" class="form-control" id="validationCustom02" placeholder="Scheme Default Currency"   required> 
                                                        <option value="ZWL"></option>
                                                    </select>                                                
                                                    <div class="valid-feedback">
                                        ...
                                        <button class="btn btn-gradient-primary" type="submit">View Contributions</button>
