                            ...
                            <div class="page-title-box">
                                <div class="float-right">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active"> Download Acturial Data</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">Download Acturial Data</h4>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="needs-validation" method="POST" action="./controllers/create_schema.php" novalidate> 
                                        <div class="form-row">
                                         ...
                                         <div class="form-row">
                                            <div class="col-md-6 mb-3">
                                                <label for="validationCustom02">Start Period</label>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <label for="validationCustom02">End Period:</label>
                                                <input type="date" name="scheme_name" class="form-control" id="validationCustom02"   required>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                        ...
                                        <button class="btn btn-gradient-primary" type="submit">Export Data</button>
                                    </form> <!--end form-->                                          
                                </div><!--end card-body-->
                            </div><!--end card-->
                        </div><!--end col-->
