                            ...
                            <div class="page-title-box">
                                <div class="float-right">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="javascript:void(0);">View/Print</a></li>
                                        <li class="breadcrumb-item active"> Pure Contributions History</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">Pure Contributions History</h4>
